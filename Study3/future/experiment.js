/*
ChangeLog
29 May 13, For Version 52a
- Added minimum width to wheel.
...
var allConditions = [
[
{"condition":1, "Version":"52a", "SpinnerID":"1",  "probabilityVector":[.38, .36, .26],  "payoffVector":[0, 30, 60],   "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"2",  "probabilityVector":[.42, .31, .27],  "payoffVector":[0, 30, 60],   "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"3",  "probabilityVector":[.41, .37, .22],  "payoffVector":[0, 30, 60],   "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"4",  "probabilityVector":[.5, .31, .19],   "payoffVector":[10, 35, 75],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"5",  "probabilityVector":[.515, .3, .185], "payoffVector":[10, 35, 75],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"6",  "probabilityVector":[.5, .32, .18],   "payoffVector":[10, 35, 75],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"7",  "probabilityVector":[.47, .28, .25],  "payoffVector":[15, 70, 80],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"8",  "probabilityVector":[.49, .27, .24],  "payoffVector":[15, 70, 80],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"9",  "probabilityVector":[.45, .29, .26],  "payoffVector":[15, 70, 80],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"10", "probabilityVector":[.43, .39, .18],  "payoffVector":[20, 45, 70],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"11", "probabilityVector":[.41, .35, .24],  "payoffVector":[20, 45, 70],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"12", "probabilityVector":[.40, .34, .26],  "payoffVector":[20, 45, 70],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"13", "probabilityVector":[.31, .25, .44],  "payoffVector":[30, 50, 95],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"14", "probabilityVector":[.33, .29, .38],  "payoffVector":[30, 50, 95],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"15", "probabilityVector":[.30, .30, .40],  "payoffVector":[30, 50, 95],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"16", "probabilityVector":[.45, .37, .18],  "payoffVector":[25, 60, 100], "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"17", "probabilityVector":[.42, .38, .20],  "payoffVector":[25, 60, 100], "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"18", "probabilityVector":[.43, .35, .22],  "payoffVector":[25, 60, 100], "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"19", "probabilityVector":[.31, .32, .37],  "payoffVector":[25, 45, 80],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"20", "probabilityVector":[.26, .32, .42],  "payoffVector":[25, 45, 80],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"21", "probabilityVector":[.30, .30, .40],  "payoffVector":[25, 45, 80],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"22", "probabilityVector":[.32, .16, .52],  "payoffVector":[20, 60, 90],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"23", "probabilityVector":[.34, .22, .44],  "payoffVector":[20, 60, 90],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"24", "probabilityVector":[.33, .20, .47],  "payoffVector":[20, 60, 90],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"25", "probabilityVector":[.21, .36, .43],  "payoffVector":[15, 50, 75],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"26", "probabilityVector":[.24, .40, .36],  "payoffVector":[15, 50, 75],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"27", "probabilityVector":[.25, .38, .37],  "payoffVector":[15, 50, 75],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"28", "probabilityVector":[.36, .40, .24],  "payoffVector":[40, 65, 100], "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"29", "probabilityVector":[.38, .34, .28],  "payoffVector":[40, 65, 100], "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"30", "probabilityVector":[.37, .32, .31],  "payoffVector":[40, 65, 100], "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"31", "probabilityVector":[.54, .30, .16],  "payoffVector":[45, 60, 90],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"32", "probabilityVector":[.52, .29, .19],  "payoffVector":[45, 60, 90],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"33", "probabilityVector":[.50, .30, .20],  "payoffVector":[45, 60, 90],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"34", "probabilityVector":[.43, .23, .34],  "payoffVector":[30, 50, 90],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"35", "probabilityVector":[.41, .24, .35],  "payoffVector":[30, 50, 90],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"36", "probabilityVector":[.39, .25, .36],  "payoffVector":[30, 50, 90],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"37", "probabilityVector":[.28, .19, .53],  "payoffVector":[20, 50, 90],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"38", "probabilityVector":[.30, .18, .52],  "payoffVector":[20, 50, 90],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"39", "probabilityVector":[.32, .18, .50],  "payoffVector":[20, 50, 90],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"40", "probabilityVector":[.27, .38, .35],  "payoffVector":[0, 40, 95],   "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"41", "probabilityVector":[.27, .40, .33],  "payoffVector":[0, 40, 95],   "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"42", "probabilityVector":[.26, .42, .32],  "payoffVector":[0, 40, 95],   "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"43", "probabilityVector":[.55, .28, .17],  "payoffVector":[10, 50, 75],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"44", "probabilityVector":[.58, .24, .18],  "payoffVector":[10, 50, 75],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"45", "probabilityVector":[.60, .24, .16],  "payoffVector":[10, 50, 75],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"46", "probabilityVector":[.26, .53, .21],  "payoffVector":[55, 70, 85],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"47", "probabilityVector":[.28, .51, .21],  "payoffVector":[55, 70, 85],  "winChoice":2},
{"condition":1, "Version":"52a", "SpinnerID":"48", "probabilityVector":[.25, .52, .23],  "payoffVector":[55, 70, 85],  "winChoice":3},
{"condition":1, "Version":"52a", "SpinnerID":"49", "probabilityVector":[.30, .52, .18],  "payoffVector":[50, 75, 90],  "winChoice":1},
{"condition":1, "Version":"52a", "SpinnerID":"50", "probabilityVector":[.32, .50, .18],  "payoffVector":[50, 75, 90],  "winChoice":2}
],
[
...
// Goes to description slide
  description: function() {
    ...
    if(experiment.firstPerson==1) {
      showSlide("description1st");
      $("#tot-num1").html(numTrials);
    } else {
...
*/
  ...
  if (numComplete == 0) { // First trial: create canvas.
      ...
      canvas1st=Raphael('wheel1st');
      //canvasOutcome=Raphael('outcomeGraphic');
      //canvasOutcome1st=Raphael('outcomeGraphic1st');
  ...
  if (numComplete > 0) {
    ...
    $("#freshGame").show();
        ...
        goButton = canvas.rect(3*canvas.width/4-20,canvas.height/2-45,90,25,0).attr({fill: "#0f0"});


        canvas1st.triangle(canvas1st.width/2, 5, 15).attr({
          "fill": "black", 
          "stroke": 0}).transform("r180");
        spinner1st = canvas1st.pieChart(canvas1st.width/2, 150, 125, probabilityVector, payoffVector,
          chosenColors, 24);
        goButton1st = canvas1st.rect(3*canvas1st.width/4-20,canvas1st.height/2-45,90,25,0).attr({fill: "#0f0"});
...
*/
        ...
        */
        ...
        // }
        $('#Outcome').html(payoffVector[winChoice-1]);
        $('#Outcome1').html(payoffVector[winChoice-1]);
        

        if(winChoice==1) {
          spinnerAngle = probabilityVector[0]/2 * 360 - 90 + (Math.random()-0.5)*10;
        } else if (winChoice==2) {
          spinnerAngle = (probabilityVector[0] + probabilityVector[1]/2) * 360 - 90 + (Math.random()-0.5)*10;
        } else {
          spinnerAngle = -1*probabilityVector[2]/2 * 360 - 90 + (Math.random()-0.5)*10;          
        }
        ...
        goButton.click(function() {
          $("#response").show(); 
          // canvasOutcome.triangle(canvasOutcome.width/2, 5, 5).attr({
          //   "fill": "black", 
          //   "stroke": 0}).transform("r180");
          // spinnerOutcome = canvasOutcome.pieChart(canvasOutcome.width/2, canvasOutcome.height/2+5, 40, 
          //   probabilityVector, payoffVector, chosenColors, 8)
          //   .transform("r" + spinnerAngle + " " + canvasOutcome.width/2 + " " + (canvasOutcome.height/2+5));
          experiment.startTime = (new Date()).getTime();
        });
        goButton1st.click(function() {
          $("#response1st").show(); 
          // canvasOutcome1st.triangle(canvasOutcome1st.width/2, 5, 5).attr({
          //   "fill": "black", 
          //   "stroke": 0}).transform("r180");
          // spinnerOutcome1st = canvasOutcome1st.pieChart(canvasOutcome1st.width/2, canvasOutcome1st.height/2+5, 40, 
          //   probabilityVector, payoffVector, chosenColors, 8)
          //   .transform("r" + spinnerAngle + " " + canvasOutcome1st.width/2 + " " + (canvasOutcome1st.height/2+5));
          experiment.startTime = (new Date()).getTime();
        });
